...
import (
	...
	errors2 "github.com/digroad/go-admin/modules/errors"
	"github.com/digroad/go-admin/modules/language"
	"github.com/digroad/go-admin/modules/logger"
	"github.com/digroad/go-admin/modules/menu"
	...
	"github.com/digroad/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/digroad/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/digroad/go-admin/blob/master/template/login/list.go
	GetAssetList() []string

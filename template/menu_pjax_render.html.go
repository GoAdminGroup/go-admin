...
// source: /Users/chenhg5/go/src/goAdmin/resources/pages/menu_pjax_render.html
// DO NOT EDIT!
package template
...
<section class="content">
	...
	for _, list := range menuEditList {
		...
		hero.EscapeHTML(list.ID, buffer)
		buffer.WriteString(`'>
            <div class="dd-handle">
                <i class="fa `)
		hero.EscapeHTML(list.Icon, buffer)
		buffer.WriteString(`"></i>&nbsp;<strong>`)
		hero.EscapeHTML(list.Name, buffer)
		buffer.WriteString(`</strong>&nbsp;&nbsp;&nbsp;<a
                    href="`)
		hero.EscapeHTML(list.Url, buffer)
		buffer.WriteString(`" class="dd-nodrag">`)
		hero.EscapeHTML(list.Url, buffer)
		buffer.WriteString(`</a>
                <span class="pull-right dd-nodrag">
                <a href="/menu/edit/show?id=`)
		hero.EscapeHTML(list.ID, buffer)
		buffer.WriteString(`"><i class="fa fa-edit"></i></a>
                <a href="javascript:void(0);" data-id="`)
		hero.EscapeHTML(list.ID, buffer)
		buffer.WriteString(`" class="tree_branch_delete"><i class="fa fa-trash"></i></a>
            </span>
            </div>
            `)
		if len(list.ChildrenList) > 0 {
			...
			for _, item := range list.ChildrenList {
				buffer.WriteString(`
                        <li class="dd-item" data-id='`)
				hero.EscapeHTML(item.ID, buffer)
				buffer.WriteString(`'>
                            <div class="dd-handle">
                                <i class="fa `)

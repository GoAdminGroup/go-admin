...
func NewPanelPjax(formData []models.FormStruct, url string, previous string, id string, title string, description string, errData models.ErrStruct, buffer *bytes.Buffer) {

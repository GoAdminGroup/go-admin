...
// source: /Users/chenhg5/go/src/goAdmin/resources/pages/menu_edit_pjax_render.html
// DO NOT EDIT!
package template
...
func MenuEditPanelPjax(menuItem menu.MenuItem, menuOption []map[string]string, buffer *bytes.Buffer) {
    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <div class="btn-group pull-right" style="margin-right: 10px">
                <a href="/menu" class="btn btn-sm btn-default"><i class="fa fa-list"></i>&nbsp;List</a>
...
<form action="/menu/edit?id=`)
	hero.EscapeHTML(menuItem.ID, buffer)
...
`)
	...
	for _, option := range menuOption {
		buffer.WriteString(`
<option value='`)
		hero.EscapeHTML(option["id"], buffer)
		buffer.WriteString(`'>`)
		hero.EscapeHTML(option["title"], buffer)
...
<input type="text" id="title" name="title" value="`)
	hero.EscapeHTML(menuItem.Name, buffer)
	buffer.WriteString(`" class="form-control title" placeholder="Input Title">
`)
...
<input style="width: 140px" type="text" id="icon" name="icon" value="`)
	hero.EscapeHTML(menuItem.Icon, buffer)
	buffer.WriteString(`" class="form-control icon iconpicker-element iconpicker-input" placeholder="Input Icon">
`)
	...
	buffer.WriteString(`
                        ...
                        `)
	buffer.WriteString(`<div class="iconpicker-popover popover fade">
    <div class="arrow"></div>
...
<input type="text" id="uri" name="uri" value="`)
	hero.EscapeHTML(menuItem.Url, buffer)
	buffer.WriteString(`" class="form-control uri" placeholder="Input URI">
`)
	...
	buffer.WriteString(`
                ...
                <div class="form-group  ">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control roles select2-hidden-accessible" style="width: 100%;" name="roles[]" multiple="" data-placeholder="Input Roles" tabindex="-1" aria-hidden="true"><option value="1">Administrator</option>
                            <option value="2">Operator</option>
                            <option value="3">SmallAdministrator</option></select>
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" name="_method" value="PUT" class="_method"><input type="hidden" name="_previous_" value="/menu" class="_previous_"><!-- /.box-footer -->
    </form>
</div>

...
// source: /Users/chenhg5/go/src/goAdmin/resources/pages/install_render.html
// DO NOT EDIT!
package template

import "bytes"

func GetInstallPage(buffer *bytes.Buffer) {
                            ...
                            <div class="span-2-5">
                                <form method="post" action="#">
                                    <div class="field" style="width: calc(73% - 0.75rem);">
                                        ...
                                        <input type="text" name="demo-name" id="host" value="" placeholder="127.0.0.1">
                                    </div>
                                    <div class="field quarter">
                                        <label for="demo-email">端口</label>
                                        <input type="email" name="demo-email" id="port" value=""
                                               placeholder="3306">
                                    </div>
                                    <div class="field">
                                        <label for="demo-name">账号</label>
                                        <input type="text" name="demo-name" id="username" value="" placeholder="root">
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="demo-email" id="database" value=""
                                               placeholder="database">
                                    </div>
                                    <div class="field" style="margin-top: 20px;">
                                        <ul class="actions">
                                            <li><input type="submit" value="连接测试" class="special color2"></li>
                        ...
                        <div class="inner columns aligned" style="padding: 2.5rem 3.5rem 2rem 3.5rem;">
                            <div class="span-2-5">
                                ...
                                <form method="post" action="#">
                                    ...
                                    <div class="field quarter">
                                        <input type="checkbox" id="demo-human1" name="demo-human1" class="color2" checked="">
                                    ...
                                    <div class="field quarter">
                                        <input type="checkbox" id="demo-human2" name="demo-human2" class="color2" checked="">
                                    ...
                                    <div class="field quarter">
                                        <input type="checkbox" id="demo-human3" name="demo-human3" class="color2" checked="">
            ...
            <div class="page-wrapper" style="margin-left: auto;margin-right:  auto;width: 1236px;">
                ...
                <div class="wrapper" style="margin-left: auto;margin-right:  auto;">
                    <section class="panel color2-alt">
                        ...
                        <div class="inner columns aligned" style="padding: 2.5rem 3.5rem 2rem 3.5rem;overflow-y: scroll;">
                            <div class="span-2-5">
                                <form method="post" action="#">
                            ...
                            <div class="span-2-5">
                                <form method="post" action="#">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="password" name="demo-password_comfirm" id="password_comfirm" value=""
                                               placeholder="root">
                                    </div>
                                    <div class="field" style="margin-top: 20px;">
                                        <ul class="actions">

...
var cn = LangSet{
	...
	"config.logger rotate encoder level":          "Level编码器",
	"config.logger rotate encoder time":           "Time编码器",
	"config.logger rotate encoder duration":       "Duration编码器",
	"config.logger rotate encoder caller":         "Caller编码器",
